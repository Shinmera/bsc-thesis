...
\begin{table}[H]
  \centering
  {
    \scriptsize
    \hspace*{-1cm}
    \begin{tabular}{|l|p{4cm}|p{3cm}|p{2.5cm}|p{2.5cm}|}
      \hline
      ...
      & Social Network
      & Stateful
      & Map, Filter, Aggregate, Window Aggregate
      \\\hline
    \end{tabular}
  }
...
\begin{table}[H]
  \centering
  {
    \scriptsize
    \hspace*{-1cm}
    \begin{tabular}{|l|p{3.5cm}|p{4cm}|p{2.5cm}|p{2cm}|}
      \hline
