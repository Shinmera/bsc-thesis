...
\scalingfigure[nex]{
  \addplot table[y index=0, x index=1] {data/scaling.csv};
  \addplot table[y index=0, x index=2] {data/scaling.csv};
  \addplot table[y index=0, x index=3] {data/scaling.csv};
  \addplot table[y index=0, x index=4] {data/scaling.csv};
