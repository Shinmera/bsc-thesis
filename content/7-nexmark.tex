...
\scalingfigure[nex]{
  \addplot table[y index=0, x index=6] {data/scaling.csv};
  \addplot table[y index=0, x index=7] {data/scaling.csv};
  \addplot table[y index=0, x index=8] {data/scaling.csv};
  \addplot table[y index=0, x index=9] {data/scaling.csv};
  \addplot table[y index=0, x index=10] {data/scaling.csv};
  \addplot table[y index=0, x index=11] {data/scaling.csv};
  \addplot table[y index=0, x index=12] {data/scaling.csv};
  \addplot table[y index=0, x index=13] {data/scaling.csv};
  \addplot table[y index=0, x index=14] {data/scaling.csv};
  \addplot table[y index=0, x index=15] {data/scaling.csv};
  \addplot table[y index=0, x index=16] {data/scaling.csv};
%  \addplot table[y index=0, x index=17] {data/scaling.csv};
