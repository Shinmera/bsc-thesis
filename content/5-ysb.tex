...
\latencyfigure[ysb]{
  \addplot table[y index=0, x index=5] {data/latency-32.csv};
}{Linlog plot of the Latency vs Rate.}

\scalingfigure[ysb]{
  \addplot table[x index=0, y index=5] {data/scaling-10000000.csv};
}{Linlog plot of the scaling behaviour.}

\cdffigure[ysb]{
  \addplot table[y index=0, x index=5] {data/cdf-32-10000000.csv};
}{CDF latency plot.}
